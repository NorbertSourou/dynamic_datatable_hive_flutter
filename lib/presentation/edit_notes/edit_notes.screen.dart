...
import 'package:bernard_app/presentation/edit_product/edit_product.screen.dart';
import 'package:bernard_app/presentation/manage_product/manage_product.screen.dart';
import 'package:flutter/material.dart';

import 'package:get/get.dart';

import 'controllers/edit_notes.controller.dart';
import 'dart:math' as math;

class EditNotesScreen extends GetView<EditNotesController> {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(EditNotesController());
    return WillPopScope(
      onWillPop: () async {
            ...
            IconButton(
                onPressed: () async {
                  if (controller.title.text.isEmpty) {
                    ...
                    final int indexToEdit = controller.notesBox!.values
                        .toList()
                        .indexWhere(
                            (item) => item['Id'] == controller.noteObx['Id']);

                    HiveService.editNotesToHive(indexToEdit, result);
